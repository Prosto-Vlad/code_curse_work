        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link" href="<?=\yii\helpers\Url::to(['librarian/catalog']);?>" style="text-decoration: underline;"><img src="/img/left.png" alt="Back" width="40" height="40"></a>
                </div>
            </div>
        </div>
    </nav>
...
$this->registerJs("
    $(document).ready(function() {
        ...
        // Встановлення значень для кожного чекбокса
...
$this->registerJs("
    $('#upd_b').click(function(e){
        ...
        $.ajax({
            url: '" . \yii\helpers\Url::to(['librarian/edit', 'id' => $book->id]) . "',
            type: 'post',
            dataType: 'json',
            data: {
                bookName: name,
            ...
            success: function(response) {
                if(response.status === 'success') {
                    window.location.href = '" . \yii\helpers\Url::to(['librarian/index']) . "';
                }
            }
        });
    });
...
$this->registerJs("
    $('#write_modal').click(function(e){
        ...
        $.ajax({
            url: '" . \yii\helpers\Url::to(['librarian/writeoff', 'id' => $book->id]) . "',
            type: 'post',
            dataType: 'json',
            data: {
                desk: desk
...
$this->registerJs("
    $('#back_b').click(function(e){
        ...
        $.ajax({
            url: '" . \yii\helpers\Url::to(['librarian/back', 'id' => $book->id]) . "',
            type: 'post',
            dataType: 'json',
            data: {
