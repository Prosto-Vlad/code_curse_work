            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="<?=\yii\helpers\Url::to(['admin/catalog']);?>" style="text-decoration: underline;">Каталог</a>
...
$this->registerJs("
    ...
    $('#add_b').click(function(e){
        window.location.href = '". \yii\helpers\Url::to(['admin/add']) ."';
    });
    ...
    $('#found_b').click(function(e){
        ...
        var selectedTags = $('#book.enabled').val();
        ...
        $.ajax({
            url: '". \yii\helpers\Url::to(['admin/found']) ."',
            type: 'post',
            dataType: 'json',
            data: {
                bookName: bookName,
                ...
                $.each(response.books, function(index, book) {
                    ...
                    $('#t_body').append(
                        '<tr>' +
                            ...
                            '<td>' + 
                                '<a href=\"' + '". \yii\helpers\Url::to(['admin/info', 'id' => '']) ."' + book.id +  '\">' +
